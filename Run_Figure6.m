...
% this will run the simulations that make up Figure 6, exploring the
% agreement between the methods in the IL6 example while also including
% aIL6R
...
% turn on aIL6R in these simulations
input.initialization_pars.start_with_drug(2) = true; % start with aIL6R
input.initialization_pars.circulation_concentration(2) = 100; % initial circulation concentration of aIL6R
...
%% ail6r concentrations by distance from blood vessel and time
figs(4) = figure("Name","Average aIL-6R by Z");
ax = gobjects(3,1);
Z = cell(1,2);
ncolors = 15;
